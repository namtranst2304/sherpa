...
export const THEME_COLORS: Record<ThemeColor, ThemeColorTokens> = {
  cyan: {
    ...
    hoverShadow: 'hover:shadow-[0_0_15px_rgba(34,211,238,0.4)]',
  },
  green: {
    hex: '#4ade80',
    rgb: '74,222,128',
    ...
    shadow: 'shadow-[0_0_15px_rgba(74,222,128,0.4)]',
    hoverShadow: 'hover:shadow-[0_0_15px_rgba(74,222,128,0.4)]',
  },
  yellow: {
    hex: '#facc15',
    rgb: '250,204,21',
    ...
    hoverShadow: 'hover:shadow-[0_0_15px_rgba(250,204,21,0.4)]',
  },
  orange: {
    hex: '#f97316',
    rgb: '249,115,22',
    ...
    hoverShadow: 'hover:shadow-[0_0_15px_rgba(249,115,22,0.4)]',
  },
  red: {
    hex: '#ef4444',
    rgb: '239,68,68',
    ...
    hoverShadow: 'hover:shadow-[0_0_15px_rgba(239,68,68,0.4)]',
  },
  zinc: {
    hex: '#a1a1aa',
    rgb: '161,161,170',
  ...
  purple: {
    ...
    hoverShadow: 'hover:shadow-[0_0_15px_rgba(192,132,252,0.4)]',
  },
  blue: {
    hex: '#60a5fa',
    rgb: '96,165,250',
