...
const pantheonImports: Record<string, () => Promise<{ default: unknown }>> = {
  ...
  'insurrection-prime-revolution': () =>
    import('./pantheon/insurrection-prime-revolution.json'),
}

const exoticMissionImports: Record<
  string,
...
export async function getDungeonData(
  slug: string,
...
export async function getPantheonData(
  slug: string,
): Promise<ActivityData | null> {
...
export async function getExoticMissionData(
  slug: string,
): Promise<ActivityData | null> {
