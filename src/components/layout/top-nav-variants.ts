  ...
  'bg-transparent uppercase tracking-widest font-mono text-sm border border-transparent rounded-none transition-all',
  {
    variants: {
      variant: {
        ...
        green:
          'hover:bg-neon-green/10 hover:text-neon-green hover:border-neon-green/30 data-[state=open]:bg-neon-green/10 data-[state=open]:text-neon-green data-[state=open]:border-neon-green/30 text-zinc-300',
        ...
        orange:
          'hover:bg-neon-orange/10 hover:text-neon-orange hover:border-neon-orange/30 data-[state=open]:bg-neon-orange/10 data-[state=open]:text-neon-orange data-[state=open]:border-neon-orange/30 text-zinc-300',
        yellow:
          'hover:bg-neon-yellow/10 hover:text-neon-yellow hover:border-neon-yellow/30 data-[state=open]:bg-neon-yellow/10 data-[state=open]:text-neon-yellow data-[state=open]:border-neon-yellow/30 text-zinc-300',
  ...
  'flex gap-6 p-6 md:w-[700px] lg:w-[950px] glass-panel border border-white/5 max-h-[90vh]',
  {
    variants: {
      variant: {
        ...
        orange:
          'border-neon-orange/30 shadow-[0_10px_40px_rgba(255,140,0,0.2)]',
        yellow:
          'border-neon-yellow/30 shadow-[0_10px_40px_rgba(252,226,5,0.2)]',
  ...
  'flex h-full w-full select-none flex-col justify-start rounded-md p-6 outline-none relative overflow-hidden bg-black/20 border border-white/5',
  {
    variants: {
      variant: {
        ...
        green:
          'bg-neon-green/5 border border-neon-green/30 shadow-[inset_0_0_20px_rgba(57,255,20,0.05)]',
        red: 'bg-black border border-neon-red/30 shadow-[inset_0_0_20px_rgba(255,0,0,0.1)]',
        orange:
          'bg-neon-orange/5 border border-neon-orange/30 shadow-[inset_0_0_20px_rgba(255,140,0,0.05)]',
        yellow:
          'bg-neon-yellow/5 border border-neon-yellow/30 shadow-[inset_0_0_20px_rgba(252,226,5,0.05)]',
...
export const topNavTitleVariants = cva(
  'mb-2 mt-4 text-lg font-black uppercase tracking-widest flex items-center gap-2',
  {
    variants: {
      variant: {
...
export const topNavCardGlowVariants = cva(
  'absolute top-0 right-0 w-32 h-32 blur-3xl -mr-10 -mt-10 pointer-events-none',
  {
    variants: {
      variant: {
