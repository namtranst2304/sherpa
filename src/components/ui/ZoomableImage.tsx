    ...
    <>
      ...
      {isOpen && typeof document !== "undefined" && createPortal(
        ...
        >
          ...
          >
            <button 
              className="absolute -top-12 right-0 md:-right-12 p-3 bg-zinc-900/80 hover:bg-zinc-800 text-white rounded-full transition-colors z-50 border border-zinc-700"
              onClick={() => setIsOpen(false)}
            >
              <X className="w-6 h-6" />
            </button>
            <div className="relative w-full flex items-center justify-center">
              <Image 
                ...
                height={height}
                unoptimized={unoptimized}
                className="object-contain max-h-[85vh] w-auto rounded-lg shadow-[0_0_30px_rgba(0,243,255,0.2)] border border-zinc-800" 
              />
            </div>
          </div>
        </div>,
