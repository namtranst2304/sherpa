  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="absolute left-0 top-0 bottom-0 w-1/2 bg-black/95 pointer-events-auto overflow-hidden"
      >
      ...
      <motion.div
        ...
        animate={{ x: isOpened ? "100%" : 0 }}
        transition={{ x: { duration, ease: [0.76, 0, 0.24, 1] } }}
        className="absolute right-0 top-0 bottom-0 w-1/2 bg-black/95 pointer-events-auto overflow-hidden"
      >
