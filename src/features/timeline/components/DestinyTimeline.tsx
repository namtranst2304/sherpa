...
export function DestinyTimeline({ eras }: DestinyTimelineProps) {
  ...
  return (
    <div
      ...
      className="no-scrollbar h-[100dvh] w-full snap-y snap-mandatory overflow-x-hidden overflow-y-auto overscroll-y-contain bg-[#050505] font-sans text-zinc-100 selection:bg-neon-cyan/30 selection:text-white"
    >
