      ...
      <div className="relative z-10 w-full h-full max-w-[1920px] mx-auto px-6 md:px-12 lg:px-24 xl:px-32 2xl:px-48 flex flex-col justify-center py-6 md:py-8 lg:py-12">
        ...
        >
          <div className="w-full h-full flex flex-col lg:flex-row gap-3 md:gap-6 lg:gap-12 items-center justify-between">
            ...
            <div className="w-full lg:w-[75%] flex-1 lg:flex-none lg:h-full flex flex-col justify-center relative min-h-0">
              <CarouselContent className="-ml-4 md:-ml-8 h-full">
                {era.events.map((event, eIdx) => {
                  ...
                  return (
                    <CarouselItem key={event.title || eIdx} className="pl-4 md:pl-8 basis-full h-full lg:h-auto">
                      <div
              ...
              <div className="flex justify-center gap-1 mt-4 lg:mt-6 pb-2">
                {Array.from({ length: count }).map((_, i) => (
                  <button
                    ...
                    aria-current={i === current - 1 ? "true" : undefined}
                  >
                    <span
                      className={`block rounded-[1px] rotate-45 transition-colors ${
                        i === current - 1 ? "w-2.5 h-2.5" : "w-2 h-2 bg-white/20 hover:bg-white/50"
                      }`}
                      style={
                        i === current - 1
              ...
              <div className="flex justify-center mt-3">
                <TTSButton
                  ...
                  theme={theme}
                  onEventChange={(i) => api?.scrollTo(i)}
