  ...
  return (
    <div className="flex max-w-4xl flex-col gap-6 p-6">
      <div className="flex items-center gap-3 border-b border-neon-yellow/30 pb-4">
        ...
        <div>
          <CyberHeading variant="exotic" className="uppercase text-neon-yellow">
      ...
      {catalystGuide.steps && catalystGuide.steps.length > 0 && (
        <div className="mt-4 flex flex-col gap-4">
          <CyberHeading size="sm" variant="default" className="uppercase text-zinc-200">
            Hướng dẫn chi tiết
          </CyberHeading>
          <CyberCard variant="yellow" padding="md" className="flex flex-col gap-4">
